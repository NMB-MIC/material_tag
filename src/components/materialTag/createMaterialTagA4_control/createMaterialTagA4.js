...
// import './createMaterialTagA4.css'
    ...
    return (
      <div className="print-container" style={{
        ...
        {this.printData.map((printItem, index) => (
          <div style={{
            float: "left", marginTop: ((index) % 8 === 0 || (index - 1) % 8 === 0 || index === 0 || index === 1) ? "28.5mm" : "0m",
            marginLeft: index % 2 === 0 ? "5mm" : "0m",
            marginRight: index % 2 === 0 ? "0mm" : "5mm"
          }}>
            <div style={{ width: '100mm', height: '65mm', borderStyle: 'solid', }}>
              ...
              <div style={{ width: '100mm', float: 'left', fontSize: '4.055mm' }}>
                <div style={{ borderStyle: 'solid', width: '30mm', borderWidth: '1px', marginLeft: '1mm', float: 'left' }}>
                  ...
                  <div style={{ borderStyle: 'solid', borderWidth: '1px' }}>Drawing Rev.</div>
                </div>
                <div style={{ borderStyle: 'solid', borderWidth: '1px', width: '43mm', float: 'left' }}>
                  ...
                  <div style={{ marginLeft: '-0.5mm', marginRight: '-0.5mm', borderStyle: 'solid', borderWidth: '1px', paddingLeft: '1mm' }}>{this.limitStr(printItem.control1, 18)}</div>
                </div>
                  ...
                  <div style={{ textAlign: 'center', padding: '1mm' }}>
                    <Zoom>
                      <QRCode
                        ...
                        value={
                          `${printItem.boxID}\t${printItem.divisionCode}\t${printItem.purchaseOrder}\t${printItem.deliveryOrder}\t${printItem.quantity}\t${printItem.supplierCode}\t${printItem.supplierName}\t${printItem.itemNumber}\t${printItem.itemName}\t${printItem.control1}\t${printItem.control2}\t${printItem.control3}`} />
                    </Zoom>
                  </div>
                  <div style={{ borderTop: 'solid 2px', width: '23mm', height: '18.15mm', textAlign: 'center' }}>
...
class CreateMaterialTag extends Component {
  ...
  async componentDidMount() {
    await require("./createMaterialTagA4.css");
    this.forceUpdate()
  }
  ...
  renderPrintMode = () => {
    return (
      <div className='card card-primary'>
        <div className='card-header'>
          <h3 class="card-title">Print mode 2</h3>
        </div>
        <div className='card-body'>
          <button className='btn btn-primary'
            onClick={() => (this.props.history.push('/MaterialTag/create_2'))}

            style={{ width: '48%', marginLeft: '1%', marginRight: '1%' }}>Label printer</button>
          <button className='btn btn-success'
            onClick={() => (this.props.history.push('/MaterialTag/createA4_2'))}
            disabled
        ...
        <div className="content-header">
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6" >
                <h1 class="m-0">Create material tag A4 2</h1>
              </div>
              <div className="col-sm-6">
